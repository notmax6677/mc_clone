...
// store last select block position (this is for block placement)
...
void place_block() {
	...
	if(selectingSomething) {
		...
		*newChunk = insert_block(newChunk, (vec4){relativeSelectPos[0], relativeSelectPos[1], relativeSelectPos[2], 4});
